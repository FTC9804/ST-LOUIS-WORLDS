 ...
 * Ax24 4-9-16 at 9:58 pm Steve -- code with new movement layout and 2 ir sensors
 *
 *
 *
...
public class Worlds_9804_RED_ClimbersFarStartUsingIR_Ax24 extends LinearOpMode {
    ...
    /*
            ...
            *          Low- 0.03
    */
    static double HIGH_GAIN = 0.09;
    static double MID_GAIN = 0.06;
    static double LOW_GAIN = 0.05;
...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 3
            driveStraightBackwardsUntilWhiteLineIsDetectedRightIR(45, 0.7);
    ...
    void proportionalLineFollowBackwardsLeftSideOfWhiteLineRightIR(double midPower, double gain) {
         ...
         *  Programmer inputs the midpower for driving
         *       MidPower = the desired midpower that you wish to have the robot run with
         *       Gain = desired gain for proportional control
         *
         */

        OpticalDistanceSensor floorIR = (OpticalDistanceSensor) hardwareMap.opticalDistanceSensor.get("rightir");

        driveGain = gain;       //OK for spin move
    ...
    void proportionalLineFollowBackwardsRightSideOfWhiteLineRightIR(double midPower, double gain) {
    ...
    void proportionalLineFollowBackwardsLeftSideOfWhiteLineLeftIR(double midPower, double gain) {
    ...
    void proportionalLineFollowBackwardsRightSideOfWhiteLineLeftIR(double midPower, double gain) {
