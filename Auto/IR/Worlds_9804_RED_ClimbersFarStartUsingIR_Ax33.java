 ...
 * Ax33 4-29-16 at 6:08 pm Etienne and Steve --updated code with new autonomous robot movement, new method for calculating distance on white line
 *
 * <p>
 * <p>
 * <p>
...
public class Worlds_9804_RED_ClimbersFarStartUsingIR_Ax33 extends LinearOpMode {
...
//        allClear.setPosition(allClearPosition);
    ...
    void LineFollowForwardsNonProportional() {
        ...
        OpticalDistanceSensor floorIR = hardwareMap.opticalDistanceSensor.get("ir");
        this.resetStartTime();
