 ...
 * Ax34 4-20-16 at 7:53 pm Steve & Etienne -- update cide with logic and proportional control revisions
 * <p>
 * <p>
 * <p>
 * <p>
 ...
 * <p>
 * referencing floorIR in this program call values from irr, which is the IR on the right side of the robot, used when red
 * <p>
 * <p>
 * ACORN = adjusted center of rotation navigation; we use this for our proportional line follow because our IR sensors are off centered
 * <p>
 * <p>
 * <p>
 * +++++++++++++++++++++++++++++++Configuration Info+++++++++++++++++++++++++++++++
 ...
 * VCFP         Yellow          IR ODS Right            ***             irr
 * VCFP         Yellow          IR ODS Left             ***             irl
...
public class Worlds_9804_RED_ClimbersFarStartUsingIR_Ax34 extends LinearOpMode {
    ...
    static int IR_THRESHOLD = 700;      //IR Light threshold ****NEEDS TO BE TESTED*****
    ...
    static int BLUE_IR_THRESHOLD = 130;
    static int RED_IR_THRESHOLD = 630;  // BASED ON BRIDGET'S TESTING please confirm
...
//        allClear.setPosition(allClearPosition);
    ...
    void driveStraightForwardsUntilBlueLineIsDetected(int heading, double midPower) {
        ...
        OpticalDistanceSensor floorIR = (OpticalDistanceSensor) hardwareMap.opticalDistanceSensor.get("irr");
    ...
    void LineFollowForwardsNonProportional() {
        ...
        OpticalDistanceSensor floorIR = hardwareMap.opticalDistanceSensor.get("irr");
        this.resetStartTime();
    ...
    void propoortionalLineFollowForDistanceWithACORNLeftSideOfLineLeftSideSensor(double distance, double midPower) {
        /*
         * How to use this method:
    ...
    void propoortionalLineFollowForDistanceWithACORNRightSideOfLineRightSideSensor(double distance, double midPower) {
        /*
         * How to use this method:
         *  Programmer inputs distance and midpower
         *      Distance = INCREMENTAL distance that you wish to have the robot run this time
