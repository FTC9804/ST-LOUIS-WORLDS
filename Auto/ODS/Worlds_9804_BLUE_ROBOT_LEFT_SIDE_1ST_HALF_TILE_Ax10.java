 ...
 * Ax00 4-25-16 at 6:45 pm Etienne -- made Ax00 for start between teeth 1-5


 * ~~~~SETUP_(TEETH 1-5)~~~~
 * (1) Left side of the robot can be placed between teeth 1-5 from the mountain perpendicular to the wall
...
public class Worlds_9804_BLUE_ROBOT_LEFT_SIDE_1ST_HALF_TILE_Ax10 extends LinearOpMode {
