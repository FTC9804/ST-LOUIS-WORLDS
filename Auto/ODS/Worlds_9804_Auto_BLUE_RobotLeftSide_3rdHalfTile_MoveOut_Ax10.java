 ...
 * Ax10 427 12:52 pm -- made this file
...
public class Worlds_9804_Auto_BLUE_RobotLeftSide_3rdHalfTile_MoveOut_Ax10 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 1
            driveStraightBackwards(0, 13.5, 0.8); //13.5 inches because it is the ROBOT_LEFT_SIDE_3RD_HALF_TILE
            ...
            //step 3
            driveStraightBackwards(-45, 50, 0.9);
