...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 10
            driveStraightBackwwardsUntilRedLineIsDetected(angleOfTriangleCalculationsDegrees, 0.5);
            ...
            //step 12
            propoortionalLineFollowForDistanceWithACORNRightSideOfLineRightSideSensor(9.5, 0.6);
    ...
    void driveStraightBackwwardsUntilRedLineIsDetected(int heading, double midPower) {
