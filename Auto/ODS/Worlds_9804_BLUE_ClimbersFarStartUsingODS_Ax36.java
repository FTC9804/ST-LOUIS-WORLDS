...
public class Worlds_9804_BLUE_ClimbersFarStartUsingODS_Ax36 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 10
            driveStraightBackwardsUntilBlueLineIsDetected(angleOfTriangleCalculationsDegrees, 0.5);
    ...
    void driveStraightForwardsUntilBlueLineIsDetected(int heading, double midPower) {
        ...
        do {
            ...
            if (rawDetectedLight > BLUE_ODS_THRESHOLD) {
                lineDetected = true;
            }
    ...
    void driveStraightBackwardsUntilBlueLineIsDetected(int heading, double midPower) {
    ...
    void spinMoveClockwiseUntilBlueLineIsDetected() {
    ...
    void lineFollowBackwardsLeftSideOfLine() {
        ...
        while (this.opModeIsActive() /* && code here for touch sensor not active*/) {
            ...
            if (rawDetectedLight > ODS_THRESHOLD) {
                leftPower = -0.9;
                rightPower = -0.5;
            } else if (rawDetectedLight < ODS_THRESHOLD) {
                leftPower = -0.5;
                rightPower = -0.9;
            } else {
                leftPower = -0.7;
