...
public class Worlds_9804_BLUE_ClimbersFarStartUsingIR_Ax32 extends LinearOpMode {
...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 7
            totalEncoderMovement = Math.abs(concludingEncoderValue - initialEncoderValue);
            ...
            //step 9
            driveStraightBackwards(angleOfTriangleCalculationsDegrees - 45, 6, 0.5);
            ...
            //step 10
            spinMoveClockwise(angleOfTriangleCalculationsDegrees - 45);
    ...
    void propoortionalLineFollowForDistanceWithAdjustedCenterOfRotationLeftSideOfLineLeftSideSensor (double distance, double midPower) {
        /*
         * How to use this method:
    ...
    void propoortionalLineFollowForDistanceWithAdjustedCenterOfRotationRightSideOfLineRightSideSensor (double distance, double midPower) {
        /*
         * How to use this method:
         *  Programmer inputs distance and midpower
         *      Distance = INCREMENTAL distance that you wish to have the robot run this time
