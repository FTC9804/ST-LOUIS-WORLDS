...
public class Worlds_9804_BLUE_ClimbersFarStartUsingODS_Ax40 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            while(this.opModeIsActive() && this.getRuntime() < 20 && stillAtWhiteLine) {
                ...
                spinMoveCounterClockwise15DegreesToCheckForWhiteLine();
            ...
            driveStraightBackwards(-90, 6.0, 0.5);
            ...
            //step 9
            proportionalLineFollowForDistanceWithACORNLeftSideOfLineLeftSideSensor(15, 0.5); //distance of 20 needs to be checked
    ...
    void spinMoveCounterClockwise15DegreesToCheckForWhiteLine() {

        /*
         * How to use this method:
         *  Run the code and watch the robot spin counter-clockwise for 15 degrees unless it sees white and then rotate to its initial position
