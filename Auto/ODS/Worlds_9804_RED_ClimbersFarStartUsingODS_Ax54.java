 ...
 * Ax53 4-25-16 at 4:23 pm Etienne -- cleaned up code and tried to fix minor bugs that were mentioned on the night of 4-23-16.
 * Ax54 4-25-16 at 5:46 pm Bridget -- changed the encoder counts
 * Ax54 4-25-16 at 6:22 pm Bridget -- switching blue code to red by adding funcions to detect red threshold
 * ~~~~SETUP_(VERSION Tx21)~~~~
...
public class Worlds_9804_RED_ClimbersFarStartUsingODS_Ax54 extends LinearOpMode {
    ...
    void driveStraightBackwardsUntilWhiteLineIsDetected(int heading, double midPower) {
        ...
        do {
            ...
            telemetry.addData("ods1 Red rear left ",  floorODS.getLightDetectedRaw());
