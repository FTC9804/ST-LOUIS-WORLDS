 ...
 * Ax12 4-27-16 at 4:01 pm Steve -- code updated with removing the 2 inches following calculationsw
 *
 *
 * ~~~~SETUP_(VERSION Tx21)~~~~
...
public class Worlds_9804_RED_FarFinish_RobotRightSide_3rdHalfTile_Ax12 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 1
            driveStraightBackwards(0, 13.5, 0.8);
