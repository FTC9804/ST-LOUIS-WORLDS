 ...
 *
 * referencing floorIR in this program call values from irl, which is the IR on the left side of the robot, used when blue
 * <p>
 ...
 * OpticalDistanceSensor floorIr = (OpticalDistanceSensor) hardwareMap.gyroSensor.get("irl");
 * <p>
 * <p>
 * NOTE ABOUT THE CODE:
...
public class Worlds_9804_BLUE_ClimbersFarStartUsingIR_Ax34 extends LinearOpMode {
...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //step 3
            spinMoveClockwise((initialGyroHeading - 45));
            ...
            do {
                ...
                spinMoveCounterClockwise(currentGlobalHeadingForSpinMoves + DELTADEGREESPINMOVE);
            ...
            proportionalLineFollowForDistanceWithACORNLeftSideOfLineLeftSideSensor((distanceFromShelterOnLine - 0.5), 0.6);
    ...
    void driveStraightForwardsUntilBlueLineIsDetected(int heading, double midPower) {
        ...
        OpticalDistanceSensor floorIR = (OpticalDistanceSensor) hardwareMap.opticalDistanceSensor.get("irl");
    ...
    void LineFollowForwardsNonProportional() {
        ...
        OpticalDistanceSensor floorIR = hardwareMap.opticalDistanceSensor.get("irl");
        this.resetStartTime();
