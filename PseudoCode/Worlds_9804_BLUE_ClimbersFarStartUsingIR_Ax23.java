...
public class Worlds_9804_BLUE_ClimbersFarStartUsingIR_Ax23 extends LinearOpMode {
    ...
    static int DESIREDLINEFOLLOWNUMBER = 80; //the number for perfect line follow along the edge of the line, NEEDS TO BE TESTED
...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive() && runMe) {     //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            //test new line follow
            LineFollowForwardsNonProportional();
//            //step 1
//            driveStraightBackwards(0, 48, 0.7);
//
...
//
//            //step 3
//            driveStraightBackwardsUntilWhiteLineIsDetected(0, 0.5);
//
//            waitOneFullHardwareCycle();
//
//            stopMotors();       //stop motors to prevent further movement
...
//
//            //step 5
//            driveStraightBackwards(0, 24, 0.6);
//
//            waitOneFullHardwareCycle();
//
//            stopMotors();       //stop motors to prevent further movement
